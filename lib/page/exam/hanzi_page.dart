...
class _HomePageState extends State<HanziPage> with TickerProviderStateMixin {
  ...
  Future<StrokeOrderAnimationController> _loadStrokeOrder(
    ...
    debugPrint(currentDirectory.absolute.path);

    //final directory = await getApplicationDocumentsDirectory();
    final directory=await getExternalStorageDirectory();
    final path=directory?.path;
    debugPrint(directory?.path) ;
    var file=File('$path/20240528.txt');
    var create = file.create();
    debugPrint(create.toString());

    file.writeAsString('hellow file');
